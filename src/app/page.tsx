      ...
      <div className="py-[90px] px-[15px] bg-stone-100">
        ...
        <div className="grid w-[80%] mx-auto px-[15px] justify-center items-center"
          ...
          <div className='px-[15px] mb-[30px]'>
                  ...
                  <div className='relative flex [@media(min-width:840px)]:flex-row  flex-col w-full h-full justify-center items-center'>
                    ...
                    <div className='w-[55%] px-[10px] h-full flex justify-center items-center'>
                      <div className='w-[350px] h-full'>
                        <ProductImageSlider slides={product1} />
                      </div>
                    </div>
                    <div className='[@media(min-width:840px)]:w-[45%] w-[100%] [@media(min-width:840px)]:px-[10px] px-10 h-full text-black font-heebo flex flex-col justify-center'>
                      <h1 className='text-[36px] mb-[5px]'>Hummingbird printed sweater</h1>
                      <div className='flex gap-4 items-center mb-5'>
                        <span className='text-[12px] line-through text-stone-500'>$17.00</span>
                        <span className='text-[18px] text-amber-700'>$13.00</span>
                        <span className='text-[12px] text-white px-[15px] py-[5px] rounded-2xl bg-black font-bold'>Sale</span>
                      </div>
                      <span>The best is yet to come! Give your walls a voice with a framed poster. This aesthethic, optimistic poster will look great in
                        your desk or in an open-space office. Painted wooden frame with passe-partout for more depth</span>
                    </div>
                  </div>
            ...
            <a className="relative w-full h-fit flex flex-col group">
